...
//sub 이미지 오버
function subOver(){
    document.getElementsByClassName('sub_image_inner_line')[0].style="animation: subimage_On 0.4s 0s forwards;";
}
function subOut(){
    document.getElementsByClassName('sub_image_inner_line')[0].style="animation: subimage_Off 0.4s 0s forwards;";
}
